...
const translations = {
  uk: {
    ...
    faq: {
      ...
      items: [
        { q: "Які жанри книг я найчастіше оформляю?", a: "Я працюю з різними жанрами, але найбільше спеціалізуюся на художній літератирі: трилерах, науковій фантастиці, фентезі. Проте завжди рада працювати і з іншими жанрами, щоб створювати обкладинки, які привернуть увагу читачів." },
    ...
    contact: {
      ...
      title: 'Дані проєкту',
      desc: 'Заповніть форму нижче, щоб я могла краще зрозуміти ваш проєкт та надати точну оцінку вартості та строків.',
      form: {
        ...
        pref_ph: "Кольори, атмосфера, symbols...",
